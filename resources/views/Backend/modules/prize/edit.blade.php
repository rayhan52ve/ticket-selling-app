...
@section('content')
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <p class="card-title">Edit Prize</p>
                    <hr>
                    <form class="form-horizontal form-material mx-2" action="{{ route('admin.prize.update',$prize) }}" accept="image/*"
                            ...
                            <div class="col-md-6">
                                <label class="image" for="imageInput">
                                    <input type="file" id="imageInput" value="{{ old('image') }}" name="image"
                                        class="form-control">
                                    @if ($prize->image)
                                        <img id="profileImage" src="{{ asset('uploads/prize/' . $prize->image) }}" height="100%"
                                            width="100%" class="rounded-top">
                                    @else
                                        <img id="profileImage" src="{{ asset('asset/no-images.png') }}" height="100%"
                                            width="100%" class="rounded-top">
                                    @endif
                                    ...
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <div class="form-outline">
                                            ...
                                            <input type="text" name="title" placeholder="Ex:- First Prize"
                                                value="{{ $prize->title }}" value="{{ old('title') }}"
                                    ...
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <div class="form-outline">
                                            ...
                                            <input type="number" name="order_by" placeholder=""
                                                value="{{ $prize->order_by }}" value="{{ old('order_by') }}"
                                    ...
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <div class="form-outline">
                                            ...
                                            <textarea name="description" placeholder="You can write a description here" rows="3"
                                                class="form-control @error('description') is-invalid @enderror">{{ $prize->description }}</textarea>
                                            @error('description')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
