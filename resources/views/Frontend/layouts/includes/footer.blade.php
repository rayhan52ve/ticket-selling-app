            ...
            <div class="container">
                ...
                <div class="row justify-content-between">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <div class="copyright">
                            © Copyright <strong><span>{{$webInfo->title ?? null}}</span></strong>. All Rights Reserved
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="social-links mb-3 mb-lg-0 text-center text-md-end">
                            <a href="{{$webInfo->facebook ?? null }}" class="facebook"><i class="bi bi-facebook"></i></a>
                            <a href="{{$webInfo->telegram ?? null }}" class="telegram"><i class="bi bi-telegram"></i></a>
                            <a href="{{$webInfo->youtube ?? null }}" class="youtube"><i class="bi bi-youtube"></i></a>
                        </div>
